...
class ExperimentConfig(object):
  ...
  default_experiments = ['crypto', 'volatility', 'electricity', 'traffic', 'favorita']
  ...
  def hyperparam_iterations(self):
    ...
    return 240 if self.experiment in ['volatility', 'crypto'] else 60
  ...
  def make_data_formatter(self):
    ...
    data_formatter_class = {
        ...
        'crypto': data_formatters.crypto.CryptoFormatter
    }
